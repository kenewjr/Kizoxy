...
*Catatan Arsitektur*: Surface adapters (commands, interactions, events) mengimpor logika dari layer `features` dan tidak pernah menyimpan business logic secara langsung.
