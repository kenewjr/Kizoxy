// modules/fixembed/fixembedResolver.js
// Orchestrator for the social-media link rewriter. The per-platform resolver
// entries live under modules/fixembed/resolvers/ and are aggregated by
// resolvers/index.js. This file only owns the URL discovery loop.

const {
  URL_REGEX,
  isSpoiler,
} = require("../../utils/helpers/fixembedResolverHelper");
