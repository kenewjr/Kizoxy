...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const userData = await client.levelStorage.getUser(targetUser.id, interaction.guildId);
    ...
    // Get rank position
    const rank = await client.levelStorage.getRank(targetUser.id, interaction.guildId) || 0;
