...
const descriptions = {
  ...
  "music/Leave.js":
    "Disconnect the bot from the voice channel and clear queue.",
  "music/Lofi.js": "Stream a continuous 24/7 Lofi radio station.",
  "music/Loop.js": "Cycle loop mode (off, track, queue).",
  "music/Lyrics.js":
    "Search and display lyrics for a song (converts JPN to romaji).",
  ...
  "music/Search.js":
    "Search for a song and provide a selection menu to play it.",
  "music/Shuffle.js": "Shuffle the order of tracks in the queue.",
  "music/Skip.js": "Skip the current song and play the next one.",
  "music/TwentyFourSeven.js":
    "Keep the bot in the voice channel permanently, even if empty.",
  ...
  "tiktok/status.js":
    "Show current monitoring status for a subscribed account.",
